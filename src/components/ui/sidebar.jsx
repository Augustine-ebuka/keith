...
function SidebarRail({ className = "", ...props }) {
  ...
  return (
    <button
      ...
      className={`hover:after:bg-sidebar-border absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-all ease-linear 
...
function SidebarInset({ className = "", ...props }) {
  return (
    <main
      ...
      md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2 ${className}`}
      {...props}
    />
  );
}
...
function SidebarGroupLabel({ className = "", asChild = false, ...props }) {
  ...
  return (
    <Comp
      ...
      className={`text-sidebar-foreground/70 ring-sidebar-ring flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium outline-none transition-all duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0 group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:opacity-0 ${className}`}
      {...props}
    />
  );
}
...
function SidebarGroupAction({ className = "", asChild = false, ...props }) {
  ...
  return (
    <Comp
      ...
      className={`text-sidebar-foreground ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground absolute top-3.5 right-3 flex aspect-square w-5 items-center justify-center rounded-md p-0 outline-none transition-transform focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0 after:absolute after:-inset-2 md:after:hidden group-data-[collapsible=icon]:hidden ${className}`}
      {...props}
    />
  );
}
...
function SidebarMenuButton({
  ...
  let activeClasses = isActive
    ...
    : "";
  const buttonClasses = `${baseClasses} ${sizeClasses} ${activeClasses} ${className}`;

  const button = (
    <Comp className={buttonClasses} data-active={isActive} {...props} />
  );
...
function SidebarMenuAction({
  ...
  return (
    <Comp
      ...
      className={`text-sidebar-foreground ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground peer-hover/menu-button:text-sidebar-accent-foreground absolute top-1.5 right-1 flex aspect-square w-5 items-center justify-center rounded-md p-0 outline-none transition-transform focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0 after:absolute after:-inset-2 md:after:hidden peer-data-[size=sm]/menu-button:top-1 peer-data-[size=default]/menu-button:top-1.5 peer-data-[size=lg]/menu-button:top-2.5 group-data-[collapsible=icon]:hidden ${
        showOnHover
...
function SidebarMenuBadge({ className = "", ...props }) {
  return (
    <div
      ...
      className={`text-sidebar-foreground pointer-events-none absolute right-1 flex h-5 min-w-5 items-center justify-center rounded-md border bg-background px-1 text-xs font-medium opacity-100 peer-data-[size=sm]/menu-button:h-4 peer-data-[size=sm]/menu-button:min-w-4 peer-data-[size=sm]/menu-button:text-[10px] peer-data-[size=lg]/menu-button:h-5 peer-data-[size=lg]/menu-button:min-w-5 peer-data-[size=lg]/menu-button:text-xs group-data-[collapsible=icon]:hidden ${className}`}
      {...props}
    />
  );
}
...
function SidebarMenuSkeleton({ className = "", ...props }) {
  return (
    <Skeleton
      ...
      className={`h-8 w-full rounded-md ${className}`}
      {...props}
    />
  );
}
